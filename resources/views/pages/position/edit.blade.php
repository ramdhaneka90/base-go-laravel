...
@section('content')
    ...
    <div class="modal-body pb-2">
        <div class="form-group row">
            <label for="division_id" class="col-sm-3 col-form-label">Divisi<sup>*</sup></label>
            <div class="col-sm-9">
                {{ Form::select('division_id', $options['divisions'], $data->division_id, ['id' => 'division_id', 'class' => 'form-control select2']) }}
